...
import { closeOutline, addOutline, removeOutline, refreshOutline, arrowForwardOutline } from 'ionicons/icons';
                                        ...
                                        <td className="product-col">
                                            <div className="product">
                                                <figure className="product-media">
                                                    <Link to="#">
                                                        <img src={process.env.PUBLIC_URL + "/assets/home/images/products/clothes-2.jpg"} alt="Product" />
                                                    </Link>
                                                </figure>
                                            ...
                                            <div className="cart-product-quantity">
                                                <div className="input-group input-spinner">
                                                    <div className="input-group-prepend">
                                                        <button style={{ minWidth: 26 }} className="btn btn-decrement btn-spinner" type="button">
                                                            <IonIcon icon={removeOutline} />
                                                        </button>
                                                    </div>
                                                    <input type="text" style={{ textAlign: 'center' }} className="form-control" required placeholder="" />
                                                    <div className="input-group-append">
                                                        <button style={{ minWidth: 26 }} className="btn btn-increment btn-spinner" type="button">
                                    ...
                                    <tr>
                                        <td className="product-col">
                                            <div className="product">
                                                <figure className="product-media">
                                                    <Link to="#">
                                                        <img src={process.env.PUBLIC_URL + "/assets/home/images/products/clothes-4.jpg"} alt="Product" />
                                                    </Link>
                                                </figure>
                                                <h3 className="product-title">
