        ...
        <div className="col-md-6">
            <div className="product-details">
                ...
                <div className="product-details-action">
                    <a href="#" className="btn-product btn-cart"><IonIcon icon={cartOutline} /><span>add to cart</span></a>
                    <a href="#" className="btn-product btn-cart" title="Wishlist"><IonIcon icon={heartOutline} /><span>Add to Wishlist</span></a>
