    ...
    <div className="product-details-tab">
      <ul className="nav nav-pills justify-content-center" role="tablist">
        <li className="nav-item">
          <a
            className={`nav-link ${
              activeTab === "product-desc-tab" ? "active" : ""
            }`}
        ...
        <li className="nav-item">
          <a
            className={`nav-link ${
              activeTab === "product-info-tab" ? "active" : ""
            }`}
        ...
        <li className="nav-item">
          <a
            className={`nav-link ${
              activeTab === "product-shipping-tab" ? "active" : ""
            }`}
        ...
        <li className="nav-item">
          <a
            className={`nav-link ${
              activeTab === "product-review-tab" ? "active" : ""
            }`}
            ...
            aria-selected={
              activeTab === "product-review-tab" ? "true" : "false"
            }
          >
            Reviews (2)
          </a>
      ...
      <div className="tab-content">
        <div
          className={`tab-pane fade ${
            activeTab === "product-desc-tab" ? "show active" : ""
          }`}
          id="product-desc-tab"
          role="tabpanel"
        ...
        <div
          className={`tab-pane fade ${
            activeTab === "product-info-tab" ? "show active" : ""
          }`}
          id="product-info-tab"
          role="tabpanel"
        ...
        <div
          className={`tab-pane fade ${
            activeTab === "product-shipping-tab" ? "show active" : ""
          }`}
        ...
        <div
          className={`tab-pane fade ${
            activeTab === "product-review-tab" ? "show active" : ""
          }`}
