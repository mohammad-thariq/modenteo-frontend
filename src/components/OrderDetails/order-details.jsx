          ...
          <div className="card">
            <div className="card-body">
              <div className="backtoOrder">
                <button className="btn btn-secondary mb-3" onClick={() => navigate('/orders')}> Back to Orders </button>
              </div>
              <h4 className="card-title">Order Details for {orderDetails.order_id}</h4>
              <div className="table-responsive">
                <table className="table">
                  <tbody>
                    ...
                    <tr>
                      <th>Ordered Date</th>
                      <td>{new Date(orderDetails.ordered_date).toLocaleString()}</td>
                    </tr>
